...
<head>
    <title>Admin Dashboard - Arg Offer</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    {{-- <link href="{{asset('backend/css/plugins/plugins.bundle.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('backend/css/plugins/style.bundle.css')}}" rel="stylesheet" type="text/css" /> --}}
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
                        ...
                        <div class="app-navbar flex-shrink-0">
                            ...
                            <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                                    data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                    <img src="{{asset(auth()->user()->avatar ?? 'assets/img/user.jpg') }}" alt="user" />
                                </div>
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <img alt="Logo" src="{{asset(auth()->user()->avatar ?? 'assets/img/user.jpg') }}" />
                                            </div>
                                            <!--end::Avatar-->
                                            ...
                                            <div class="d-flex flex-column">
                                                <div class="fw-bold d-flex align-items-center fs-5">
                                                    {{Auth::guard('admin')->name}} <span
                                                        class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>
                                                </div>

                                                <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">
                                                    @if(auth('admin')->user()->email == ENV('SUPER_ADMIN')) Super Admin @else Admin @endif </a>
                                            </div>
                                            <!--end::Username-->
                                        </div>
                                    </div>
            ...
            <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                ...
                <div id="kt_app_sidebar" class="app-sidebar  flex-column " data-kt-drawer="true"
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        ...
                        <a href="index.html">
                            ...
                            <img alt="Logox" src="{{asset('assets/media/logos/default-small.svg')}}"
                ...
                <!--begin::Main-->
                <div class="app-main flex-column flex-row-fluid" id="kt_app_main" style="min-height:92vh;">
                    ...
                    <div id="kt_app_footer" class="app-footer ">
                        ...
                        <div
                            ...
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="https://insomniacafe.org/" target="_blank"
                                    class="text-gray-800 text-hover-primary">InsomniaCafe</a>
                            </div>
                            <!--end::Copyright-->

                            <!--begin::Menu-->
                            <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                                <li class="menu-item"><a href="https://insomniacafe.org/contact" target="_blank"
